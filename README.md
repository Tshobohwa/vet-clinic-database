...
<img src='./assets/vet_clinic_diagram.png' width='800px'/>
...
- To have postgreSql installed in your computer.
...
```
  cd my-folder
  git clone https://github.com/Tshobohwa/vet-clinic-database.git
```
...
Feel free to check the [issues page](https://github.com/Tshobohwa/vet-clinic-database/issues).
