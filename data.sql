...
INSERT INTO animals (id, name, date_of_birth, escape_attemps, neutered, weight_kg)
    VALUES (5, 'Charmander', '2020-02-08', 0, false, -11),
           ...
           (8, 'Angemon', '2005-12-06', 1, true, -45),
...
UPDATE animals SET owner_id = ( SELECT id FROM owners WHERE full_name = 'Jennifer Orwel') WHERE name IN ('Gabumon' ,'Pikachu');
...
INSERT INTO visits (animal_id, vet_id, visit_date)
    VALUES  ((SELECT id FROM animals WHERE name = 'Agumon'), (SELECT id FROM vets WHERE name = 'William Tatcher'), '2020-05-24'),
            ...
            ((SELECT id FROM animals WHERE name = 'Boarmon'), (SELECT id FROM vets WHERE name = 'Maisy Smith'), '2020-03-08'),
